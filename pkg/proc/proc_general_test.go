...
func TestGenericFunctionParser(t *testing.T) {
	...
	var testCases = []struct{ name, pkg, rcv, base string }{
		{"github.com/fansqz/delve.afunc", "github.com/fansqz/delve", "", "afunc"},
		{"github.com/fansqz/delve..afunc", "github.com/fansqz/delve", "", "afunc"}, // malformed
		{"github.com/fansqz/delve.afunc[some/[thing].el se]", "github.com/fansqz/delve", "", "afunc[some/[thing].el se]"},
		{"github.com/fansqz/delve.Receiver.afunc", "github.com/fansqz/delve", "Receiver", "afunc"},
		{"github.com/fansqz/delve.(*Receiver).afunc", "github.com/fansqz/delve", "(*Receiver)", "afunc"},
		{"github.com/fansqz/delve.Receiver.afunc[some/[thing].el se]", "github.com/fansqz/delve", "Receiver", "afunc[some/[thing].el se]"},       // malformed
		{"github.com/fansqz/delve.(*Receiver).afunc[some/[thing].el se]", "github.com/fansqz/delve", "(*Receiver)", "afunc[some/[thing].el se]"}, // malformed
		{"github.com/fansqz/delve.Receiver[some/[thing].el se].afunc", "github.com/fansqz/delve", "Receiver[some/[thing].el se]", "afunc"},
		{"github.com/fansqz/delve.(*Receiver[some/[thing].el se]).afunc", "github.com/fansqz/delve", "(*Receiver[some/[thing].el se])", "afunc"},
