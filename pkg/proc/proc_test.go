...
import (
	...
	"github.com/fansqz/delve/pkg/proc/core"
	"github.com/fansqz/delve/pkg/proc/gdbserial"
...
func TestCGONext(t *testing.T) {
	...
	skipOn(t, "broken - see https://github.com/fansqz/delve/issues/3158", "darwin", "amd64")
...
func TestIssue414(t *testing.T) {
	...
	withTestProcess("math", t, func(p *proc.Target, grp *proc.TargetGroup, fixture protest.Fixture) {
		...
		for {
			...
			// See: https://github.com/fansqz/delve/pull/2082
			if f == fixture.Source {
				err = grp.Step()
			} else {
				err = grp.Next()
...
func TestVariablesWithExternalLinking(t *testing.T) {
	...
	//  https://github.com/fansqz/delve/issues/2346
...
func TestWatchpointsBasic(t *testing.T) {
	...
	skipOn(t, "see https://github.com/fansqz/delve/issues/2768", "windows")
	protest.AllowRecording(t)
