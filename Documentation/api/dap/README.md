...
See [dap.Server.handleRequest](https://github.com/fansqz/delve/search?q=handleRequest) and capabilities set in [dap.Server.onInitializeRequest](https://github.com/fansqz/delve/search?q=onInitializeRequest) for an up-to-date list of supported requests and options.
...
<tr><td rowspan=5>launch<br><a href="https://pkg.go.dev/github.com/fansqz/delve/service/dap#LaunchConfig">godoc</a>
...
<tr><td rowspan=2>attach<br><a href="https://pkg.go.dev/github.com/fansqz/delve/service/dap#AttachConfig">godoc</a>
...
<td>The client would expect `host:port` specification of an external (a.k.a. remote) server that the user already started with target <a href="https://github.com/fansqz/delve/blob/master/Documentation/usage/README.md">command and args</a>.
</tr>
</table>
...
The initial DAP support was released in [v1.6.1](https://github.com/fansqz/delve/releases/tag/v1.6.1) with many additional improvements in subsequent versions. The [remote attach](https://github.com/fansqz/delve/issues/2328) support was added in [v1.7.3](https://github.com/fansqz/delve/releases/tag/v1.7.3).
