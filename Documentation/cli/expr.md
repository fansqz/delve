...
These limits can be configured with `max-string-len` and `max-array-values`. See [config](https://github.com/fansqz/delve/tree/master/Documentation/cli#config) for usage.
