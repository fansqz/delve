...
import (
	...
	"github.com/fansqz/delve/pkg/terminal"
...
func TestTypecheckRPC(t *testing.T) {
	...
	pkgs, err := packages.Load(cfg, "github.com/fansqz/delve/service/rpc2")
	if err != nil {
		t.Fatal(err)
	}
	...
	packages.Visit(pkgs, func(pkg *packages.Package) bool {
		if pkg.PkgPath != "github.com/fansqz/delve/service/rpc2" {
			return true
		}
...
func TestVersion(t *testing.T) {
	...
	want1 := []byte("mod\tgithub.com/fansqz/delve")
...
func TestStaticcheck(t *testing.T) {
	...
	args := []string{"-tests=false", "-checks=all,-SA1019,-ST1000,-ST1003,-ST1016,-S1021,-ST1023", "github.com/fansqz/delve/..."}
