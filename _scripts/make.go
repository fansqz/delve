...
const DelveMainPackagePath = "github.com/fansqz/delve/cmd/dlv"
...
`,
	...
	integration 	tests github.com/fansqz/delve/service/test
...
func testSetToPackages(testSet string) []string {
	...
	case "basic":
		return []string{"github.com/fansqz/delve/pkg/proc", "github.com/fansqz/delve/service/test", "github.com/fansqz/delve/pkg/terminal"}

	case "integration":
		return []string{"github.com/fansqz/delve/service/test"}
